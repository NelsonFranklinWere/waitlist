      ...
      <section className="relative text-white flex flex-col bg-blue-950 w-full">
        ...
        <div className="container-max relative z-10 py-4 sm:py-6 md:py-8 lg:py-12 w-full">
          <div className="text-center max-w-4xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 w-full">
            ...
            <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-4xl font-bold mb-1 sm:mb-1.5 md:mb-2">
              Ongozacyberhub (OCH)
            </h1>
            <p className="text-[10px] sm:text-xs md:text-sm lg:text-lg text-blue-100 mb-2 sm:mb-2.5 md:mb-4">
              Africa&apos;s Cyber Talent Platform
            </p>

            {/* Key Value Props - One Row */}
            <div className="grid grid-cols-3 gap-1 sm:gap-1.5 md:gap-2 mb-2 sm:mb-2.5 md:mb-4">
            ...
            {/* Compact Countdown */}
            <div className="mb-0">
              <h2 className="text-xs sm:text-sm md:text-base lg:text-lg font-bold mb-1 sm:mb-1.5 md:mb-2 text-blue-100">
                Launching Soon!
              </h2>
              <CountdownTimer />
            </div>
